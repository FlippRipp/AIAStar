...
public:
	...
	*/
	...
	UFUNCTION(BlueprintImplementableEvent, Category = "Player", meta = (DisplayName = "OnProcess"))
	void ShowPathPoint(FVector PathPoint);
...
private:
	...
	bool bIsSecondConfirm = false;

	bool FindPath(FVector StartPosition, FVector TargetPosition, TArray<FFGTileinfo*>&);
